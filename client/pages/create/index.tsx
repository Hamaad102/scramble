...
// Style
import { AltButtonColors, CustomInputColors } from '../../styles/colors'
...
const Create: NextPage = () => {
	...
	// State
	const [newLobby, setLobby] = useState<string>(lobbyName)
	const [password, setPassword] = useState<string>(lobbyPassword)
	...
	// @ts-ignore
	const updateName = (e: ChangeEvent) => setLobby(e.target.value)
	// @ts-ignore
	const updatePassword = (e: ChangeEvent) => setPassword(e.target.value)

	const create = (e: FormEvent) => {
		e.preventDefault()
		createLobby(newLobby, password)
		setLoading(true)
	}
	...
	return (
		<ThemeProvider theme={darkMode ? dark : light}>
			<div>
				<Head>
					<title>Scramble - Create Lobby</title>
					<link
							...
							<>
								...
								>
									...
									>
										...
										This lobby name is already in use!
									</Alert>
								</Dialog>
								<Stack
